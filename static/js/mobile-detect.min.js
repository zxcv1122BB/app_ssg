...
/*!@license Copyright 2013, Heinrich Goebl, License: MIT, see https://github.com/hgoebl/mobile-detect.js*/!function (a, b) {
  a(function () {
    ...
    return f.FALLBACK_PHONE = "UnknownPhone", f.FALLBACK_TABLET = "UnknownTablet", f.FALLBACK_MOBILE = "UnknownMobile", g = "isArray" in Array ? Array.isArray : function (a) {
      ...
      if (h.call(i, a)) for (c = i[a], e = c.length, d = 0; d < e; ++d) {
    ...
    } : e.isPhoneSized = function () { }, e._impl = f, e.version = "1.3.7 2017-09-06", e;
  });
}(function (a) {
...
var browserType = {
    ...
    var browser = {
      versions: function () {
        ...
        return { //移动终端浏览器版本信息
          ...
          //以后,打包后的app标记
          lsAPP: u.indexOf('lsAPP') > -1 //是否为lsAPP客户端
        };
      }(),
  ...
  isPhoneDevice: function isPhoneDevice() {
    ...
    //console.info("当前系统型号:"+os + "---" + model);
    var sysParam = { 'channel': os, 'device': model };
    return sysParam;
  },

  //初始化设备型号
  initMethod: function initMethod(name) {
    var resultData = browserType.IsPC(),
      systemParam;
    //console.info(resultData);
    if (resultData.pc) {
      systemParam = { 'channel': 'PC', 'device': 'PC' };
    } else if (resultData.mobile) {
      systemParam = browserType.isPhoneDevice();
    } else if (resultData.lsAPP) {
      systemParam = browserType.isPhoneDevice();
    }
    systemParam.userName = name;
    return systemParam;
  }
};
