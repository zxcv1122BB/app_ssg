            ...
            <div class="info-wrapper clearfix">
                <div class="info-top clearfix">
                    ...
                    <div class="recent">
                        ...
                        <p class="btn_banner" v-if="previousIssue">
                            第<span style="color:red;">{{previousIssue}}</span>{{$t('期开奖')}}
                            <b class="ico" style="right: 1.6rem;"></b>
                        </p>
                        <p class="banner_num">
                           <span  style="color:red;font-size:1.2rem;line-height:2.5rem;" v-if="previousIssue_tips">{{$t('开奖中')}}...</span>
                            <span v-else-if="recentlyNum.length==0" style="font-size: 1.5rem;color: red;">{{$t('数据获取中')}}...</span>
