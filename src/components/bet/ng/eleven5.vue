    ...
    <div id="ssc">
        ...
        <div class="pay" style="display: none">
            ...
            <div class="after_no">
                ...
                <p class="total">
                    <label for="">{{$t('追')}}<input type="text" v-model="continue_periods" placeholder="1" @keyup="handleChase" maxlength="2" @blur="!continue_periods?continue_periods=1:continue_periods=continue_periods">{{$t('{{$t('期')}}')}}</label>
                </p>
            </div>
