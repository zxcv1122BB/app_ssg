       ...
       <header id="header">
            ...
            <div class="info">
                ...
                <div class="info_right" v-cloak>
                    ...
                    <p v-if="qici">
                        <span v-cloak>{{$t('第')}}{{qici}}{{$t('期')}}</span>
                        <span id="flag">{{$t('即将开奖')}}...</span>
                    </p>
                    <p v-else>
            ...
            <div id="pullrefresh">
                <ul class="award">
                    <li v-for='item in datas'>
                        <p>
                            <span v-cloak>{{$t('第')}}{{item.issue}}{{$t('期')}}</span>
    ...
    export  default {
        ...
        methods:{
          ...
          initData:function(){
            ...
            this.bet_url = localStorage.lottery_url.replace("_", "").replace(".html", "").replace("?", "/");
            ...
            setTimeFn:function(lastTime,startTime){
                ...
                if(deadlineT >= 0){
                    ...
                    _this.courtDown = _sthis.$t('正在请求数据') + "...";
                    clearInterval(_this.deadlineTiming);
                    _this.deadlineTiming = "";
