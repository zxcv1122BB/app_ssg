                        ...
                        <div class="info-top clearfix">
                            <div class="countdown">
                                ...
                                <template v-if="preventBanner!=0">
                                    <p v-if="!isNaN(preventBanner)">{{$t('距离')}}
                            ...
                            <div class="recent">
                                ...
                                <p class="btn_banner" v-if="previousIssue">
                                    第<span class="red">{{(oneTypeId == 15||oneTypeId == 34)?previousIssue.substring(3,previousIssue.length):previousIssue}}</span>{{$t('期开奖')}}
                                    <b class="ico" style="right: 1.6rem;"></b>
                                </p>
                                <p class="banner_num">
                                    <span class="red" style="font-size: 1.2rem;line-height:2.5rem;"
                                          v-if="previousIssue_tips">{{$t('开奖中')}}...</span>
                    ...
                    <div class="main">
                        ...
                        <div class="gamePlan" v-cloak>
                            <span class="presentPlan" v-show="showGamePlan!==2&&isPlan==1"
                                  @click="getPlanDataList(1)"><b>{{$t('计划')}}:</b>{{nowGamePlan}}
